...
public class Servidor {
    ...
    public Servidor() {
        ...
        cadastros[99].put("email", "admin@admin.com");
        cadastros[99].put("tipo", "admin");
        cadastros[99].put("password", "E00CF25AD42683B3DF678C61F42C6BDA");       
        ...
        cadastros[1].put("password", "E10ADC3949BA59ABBE56E057F20F883");
                            ...
                            if (dataIn != null) {
                                ...
                                if (!JwtUtil.isUserAdmin(token) && tipo.equals("admin")) {
                                    ...
                                    if (usuarioId >= 0 && usuarioId < cadastros.length) {
                                        ...
                                        novoCadastro.put("password", senha);
